...
class CloudKitManager {
    ...
    func createSharingZone() {
        ...
        CKContainer.default().publicCloudDatabase.add(modifyZonesOperation)
    }
    ...
    func createCloudSharingControllerWith(cloudKitSharable: CloudKitSharable) -> UICloudSharingController {
        ...
        let cloudSharingController = UICloudSharingController { (cloudSharingController, preparationCompletionHandler) in
            ...
            CloudKitManager.shared.saveRecordsToCloudKit(record: [cloudKitSharable.cloudKitRecord, share], database: CKContainer.default().publicCloudDatabase, perRecordCompletion: nil, completion: { (_, _, error) in
